const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-03-31', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: 'chancesha.cn', url: 'https://chancesha.cn' },
    { title: '欢迎友链！', url: 'https://www.chancesha.com/links' }
  ],
  ...
  INFO_CARD_URL: 'https://github.com/ghstaytrue', // 个人资料底部按钮链接
